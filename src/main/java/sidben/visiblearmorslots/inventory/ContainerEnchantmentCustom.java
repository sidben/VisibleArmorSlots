...
public class ContainerEnchantmentCustom extends Container {
    ...
    public ContainerEnchantmentCustom(InventoryPlayer playerInv, World worldIn)
    {
    	...
    	LogHelper.info("ContainerEnchantmentCustom() - Origin " + BlockPos.ORIGIN);
    }

    public ContainerEnchantmentCustom(InventoryPlayer playerInv, World worldIn, BlockPos pos)
    {
    	LogHelper.info("ContainerEnchantmentCustom() - " + pos);
        ...
        this.tableInventory = new InventoryBasic("Enchant", true, 2)
        {
            ...
            {
                super.markDirty();
                ContainerEnchantmentCustom.this.onCraftMatrixChanged(this);
            }
        };
    ...
    {
    	boolean result = this.worldPointer.getBlockState(this.position).getBlock() != Blocks.enchanting_table ? false : playerIn.getDistanceSq((double)this.position.getX() + 0.5D, (double)this.position.getY() + 0.5D, (double)this.position.getZ() + 0.5D) <= 64.0D;;
    	return result ;
    }
