...
public class GuiEnchantmentCustom extends GuiContainer {
    ...
    private ContainerEnchantmentCustom container;
    ...
    public GuiEnchantmentCustom(InventoryPlayer inventory, World worldIn)
    {
        super(new ContainerEnchantmentCustom(inventory, worldIn));
        this.playerInventory = inventory;
        this.container = (ContainerEnchantmentCustom)this.inventorySlots;
    }
    ...
    {
        this.fontRendererObj.drawString("Hello World", 12, 5, 4210752);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int j = 0; j < 3; ++j)
        {
            ...
            Enchantment enchantment = Enchantment.getEnchantmentByID(this.container.field_185001_h[j]);
            int l = this.container.field_185002_i[j];
            int i1 = j + 1;
